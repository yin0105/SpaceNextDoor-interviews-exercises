                ...
                return (
                    <TableRow key={price.size}>
                        ...
                        <TableCell className={last ? classes.borderNull : classes.tableCell} align="center">
                            <Typography variant="body2" className={classes.tableBodyText}>{price.averagePrice}$</Typography>
                        </TableCell>
                        <TableCell className={last ? classes.borderNull : classes.tableCell} align="right">
                            <Typography variant="body2" className={classes.tableBodyText}>{price.lowestPrice}$</Typography>
                        </TableCell>
                    </TableRow>
                )
            })}
